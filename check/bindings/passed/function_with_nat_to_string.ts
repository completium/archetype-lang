...
export class Function_with_nat_to_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/function_with_nat_to_string.arl", {}, params)).address;
        this.address = address;
    }
...
export const function_with_nat_to_string = new Function_with_nat_to_string();
