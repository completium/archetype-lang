...
export class my_record implements att.ArchetypeType {
    constructor(public id: string, public v: att.Int, public n: att.Nat) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([att.string_to_mich(this.id), this.v.to_mich(), this.n.to_mich()]);
    }
...
export class Test_record_simple {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_record_simple.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_record_simple = new Test_record_simple();
