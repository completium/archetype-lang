...
export class my_asset_value implements att.ArchetypeType {
    constructor(public value: att.Nat, public b: boolean) { }
    toString(): string {
...
export class Test_asset_update_2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_update_2.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_update_2 = new Test_asset_update_2();
