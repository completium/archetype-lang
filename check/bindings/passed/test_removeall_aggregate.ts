...
export class my_asset_value implements att.ArchetypeType {
    constructor(public value: att.Int, public col: Array<att.Nat>) { }
    toString(): string {
...
export class Test_removeall_aggregate {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_removeall_aggregate.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_removeall_aggregate = new Test_removeall_aggregate();
