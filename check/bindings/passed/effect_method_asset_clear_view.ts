...
export class Effect_method_asset_clear_view {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_clear_view.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_clear_view = new Effect_method_asset_clear_view();
