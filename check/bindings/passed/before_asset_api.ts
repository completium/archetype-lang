...
export class Before_asset_api {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/before_asset_api.arl", {}, params)).address;
        this.address = address;
    }
...
export const before_asset_api = new Before_asset_api();
