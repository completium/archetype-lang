...
export class Expr_mk_big_map {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_mk_big_map.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_mk_big_map = new Expr_mk_big_map();
