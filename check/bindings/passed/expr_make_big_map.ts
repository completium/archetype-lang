...
export class Expr_make_big_map {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_make_big_map.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_make_big_map = new Expr_make_big_map();
