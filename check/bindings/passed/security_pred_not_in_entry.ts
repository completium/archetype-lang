...
export class Security_pred_not_in_entry {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/security_pred_not_in_entry.arl", {}, params)).address;
        this.address = address;
    }
...
export const security_pred_not_in_entry = new Security_pred_not_in_entry();
