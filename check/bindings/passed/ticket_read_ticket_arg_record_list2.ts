...
const callback_arg_to_mich = (input: Array<[
    att.Nat,
    att.Ticket<string>
]>): att.Micheline => {
...
export class Ticket_read_ticket_arg_record_list2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_read_ticket_arg_record_list2.arl", {}, params)).address;
        this.address = address;
    }
    async callback(input: Array<[
        att.Nat,
        att.Ticket<string>
    ...
    async get_callback_param(input: Array<[
        att.Nat,
        att.Ticket<string>
...
export const ticket_read_ticket_arg_record_list2 = new Ticket_read_ticket_arg_record_list2();
