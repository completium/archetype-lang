...
export class Asset_iterable_big_map_expression_get {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_iterable_big_map_expression_get.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_iterable_big_map_expression_get = new Asset_iterable_big_map_expression_get();
