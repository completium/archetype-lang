...
export const o_asset_container_mich_type: att.MichelineType = att.pair_annot_to_mich_type("map", att.prim_annot_to_mich_type("string", []), att.prim_annot_to_mich_type("nat", []), []);
...
export class Addupdate_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/addupdate_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const addupdate_partition = new Addupdate_partition();
