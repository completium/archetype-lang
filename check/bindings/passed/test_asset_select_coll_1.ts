...
export class Test_asset_select_coll_1 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_select_coll_1.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_select_coll_1 = new Test_asset_select_coll_1();
