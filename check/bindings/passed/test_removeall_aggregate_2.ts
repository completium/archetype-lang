...
export class Test_removeall_aggregate_2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_removeall_aggregate_2.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_removeall_aggregate_2 = new Test_removeall_aggregate_2();
