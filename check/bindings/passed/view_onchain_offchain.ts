...
export class View_onchain_offchain {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/view_onchain_offchain.arl", {}, params)).address;
        this.address = address;
    }
...
export const view_onchain_offchain = new View_onchain_offchain();
