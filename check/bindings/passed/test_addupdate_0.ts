...
export class my_asset_value implements att.ArchetypeType {
    constructor(public v: att.Nat, public value: att.Int) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.v.to_mich(), this.value.to_mich()]);
    }
...
export class Test_add_update_0 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_add_update_0.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_add_update_0 = new Test_add_update_0();
