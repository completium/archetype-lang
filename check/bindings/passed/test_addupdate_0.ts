...
export class Test_addupdate_0 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_addupdate_0.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_addupdate_0 = new Test_addupdate_0();
