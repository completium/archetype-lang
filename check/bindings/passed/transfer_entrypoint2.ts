...
export class Transfer_entrypoint2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/transfer_entrypoint2.arl", {}, params)).address;
        this.address = address;
    }
...
export const transfer_entrypoint2 = new Transfer_entrypoint2();
