...
export class Test_asset_multi_key {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_multi_key.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_multi_key = new Test_asset_multi_key();
