...
export class Test_transition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_transition.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_transition = new Test_transition();
