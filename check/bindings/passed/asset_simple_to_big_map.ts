...
export class Asset_simple_to_big_map {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_simple_to_big_map.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_simple_to_big_map = new Asset_simple_to_big_map();
