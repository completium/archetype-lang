...
export class Effect_method_asset_remove_asset {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_remove_asset.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_remove_asset = new Effect_method_asset_remove_asset();
