...
export class Expr_formula_iterated_collection {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_formula_iterated_collection.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_formula_iterated_collection = new Expr_formula_iterated_collection();
