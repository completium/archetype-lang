...
export class Effect_method_asset_update_all_coll_1 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_update_all_coll_1.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_update_all_coll_1 = new Effect_method_asset_update_all_coll_1();
