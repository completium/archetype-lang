...
export class Expr_method_asset_sum {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_method_asset_sum.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_method_asset_sum = new Expr_method_asset_sum();
