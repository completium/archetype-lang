...
export class Called_by_an_asset {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/called_by_an_asset.arl", {}, params)).address;
        this.address = address;
    }
...
export const called_by_an_asset = new Called_by_an_asset();
