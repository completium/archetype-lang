...
export class Security_pred_transferred_to {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/security_pred_transferred_to.arl", {}, params)).address;
        this.address = address;
    }
...
export const security_pred_transferred_to = new Security_pred_transferred_to();
