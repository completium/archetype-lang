...
export class Simple_sequence {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/simple_sequence.arl", {}, params)).address;
        this.address = address;
    }
...
export const simple_sequence = new Simple_sequence();
