...
export class Expr_record_lit {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_record_lit.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_record_lit = new Expr_record_lit();
