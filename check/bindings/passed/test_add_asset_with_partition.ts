...
export class Test_add_asset_with_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_add_asset_with_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_add_asset_with_partition = new Test_add_asset_with_partition();
