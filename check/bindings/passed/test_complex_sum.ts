...
export class Test_complex_sum {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_complex_sum.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_complex_sum = new Test_complex_sum();
