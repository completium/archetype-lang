...
export class Effect_method_asset_add_asset2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_add_asset2.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_add_asset2 = new Effect_method_asset_add_asset2();
