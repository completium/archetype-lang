...
export class Test_contains_get {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_contains_get.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_contains_get = new Test_contains_get();
