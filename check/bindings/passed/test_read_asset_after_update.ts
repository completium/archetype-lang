...
export class Test_read_asset_after_update {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_read_asset_after_update.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_read_asset_after_update = new Test_read_asset_after_update();
