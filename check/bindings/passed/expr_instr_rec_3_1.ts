...
export class Expr_instr_rec_3_1 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_instr_rec_3_1.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_instr_rec_3_1 = new Expr_instr_rec_3_1();
