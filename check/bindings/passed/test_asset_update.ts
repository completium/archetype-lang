...
export class Test_asset_update {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_update.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_update = new Test_asset_update();
