...
export class Section_constant_effect {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/section_constant_effect.arl", {}, params)).address;
        this.address = address;
    }
...
export const section_constant_effect = new Section_constant_effect();
