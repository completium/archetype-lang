...
export class Ticket_var_detach_option {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_var_detach_option.arl", {}, params)).address;
        this.address = address;
    }
...
export const ticket_var_detach_option = new Ticket_var_detach_option();
