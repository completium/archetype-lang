...
export class Custom_storage5 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/custom_storage5.arl", {}, params)).address;
        this.address = address;
    }
...
export const custom_storage5 = new Custom_storage5();
