...
export class Entry_section_called_by_otherwise {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/entry_section_called_by_otherwise.arl", {}, params)).address;
        this.address = address;
    }
...
export const entry_section_called_by_otherwise = new Entry_section_called_by_otherwise();
