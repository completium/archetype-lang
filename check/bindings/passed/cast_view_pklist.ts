...
export class Cast_view_pklist {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/cast_view_pklist.arl", {}, params)).address;
        this.address = address;
    }
...
export const cast_view_pklist = new Cast_view_pklist();
