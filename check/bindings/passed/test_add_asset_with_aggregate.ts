...
export class Test_add_asset_with_aggregate {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_add_asset_with_aggregate.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_add_asset_with_aggregate = new Test_add_asset_with_aggregate();
