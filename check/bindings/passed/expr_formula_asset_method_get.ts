...
export class Expr_formula_asset_method_get {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_formula_asset_method_get.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_formula_asset_method_get = new Expr_formula_asset_method_get();
