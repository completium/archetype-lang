...
export class Asset_iterable_big_map_effect_add {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_iterable_big_map_effect_add.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_iterable_big_map_effect_add = new Asset_iterable_big_map_effect_add();
