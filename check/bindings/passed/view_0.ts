...
export class View_args_storage_no_no {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/view_args_storage_no_no.arl", {}, params)).address;
        this.address = address;
    }
...
export const view_args_storage_no_no = new View_args_storage_no_no();
