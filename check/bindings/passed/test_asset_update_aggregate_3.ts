...
export class Test_asset_update_aggregate_3 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_update_aggregate_3.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_update_aggregate_3 = new Test_asset_update_aggregate_3();
