...
export class Remove_asset_with_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/remove_asset_with_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const remove_asset_with_partition = new Remove_asset_with_partition();
