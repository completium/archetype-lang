...
export class List_option {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/list_option.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_l(): Promise<Array<att.Option<att.Nat>>> {
        if (this.address != undefined) {
...
export const list_option = new List_option();
