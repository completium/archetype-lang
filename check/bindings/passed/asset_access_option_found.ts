...
export class Asset_access_option_found {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_access_option_found.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_access_option_found = new Asset_access_option_found();
