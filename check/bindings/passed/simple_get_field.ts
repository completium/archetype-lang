...
export class Simple_get_field {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/simple_get_field.arl", {}, params)).address;
        this.address = address;
    }
...
export const simple_get_field = new Simple_get_field();
