...
export class Asset_iterable_big_map_effect_removeif {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_iterable_big_map_effect_removeif.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_iterable_big_map_effect_removeif = new Asset_iterable_big_map_effect_removeif();
