...
export class Test_record_assign_1 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_record_assign_1.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_record_assign_1 = new Test_record_assign_1();
