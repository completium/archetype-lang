...
export class Ticket_var_or_right {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_var_or_right.arl", {}, params)).address;
        this.address = address;
    }
...
export const ticket_var_or_right = new Ticket_var_or_right();
