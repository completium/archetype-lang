...
export class Update_minus_equal {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/update_minus_equal.arl", {}, params)).address;
        this.address = address;
    }
...
export const update_minus_equal = new Update_minus_equal();
