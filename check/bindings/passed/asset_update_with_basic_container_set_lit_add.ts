...
export class Asset_update_with_basic_container_set_lit_add {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_update_with_basic_container_set_lit_add.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_update_with_basic_container_set_lit_add = new Asset_update_with_basic_container_set_lit_add();
