...
export class Import_arl_constant_use_all {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/import_arl_constant_use_all.arl", {}, params)).address;
        this.address = address;
    }
...
export const import_arl_constant_use_all = new Import_arl_constant_use_all();
