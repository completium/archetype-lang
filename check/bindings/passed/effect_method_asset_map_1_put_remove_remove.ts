...
export class Effect_method_asset_map_1_put_remove_remove {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_map_1_put_remove_remove.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_map_1_put_remove_remove = new Effect_method_asset_map_1_put_remove_remove();
