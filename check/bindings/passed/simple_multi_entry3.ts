...
export class Simple_multi_entry3 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/simple_multi_entry3.arl", {}, params)).address;
        this.address = address;
    }
...
export const simple_multi_entry3 = new Simple_multi_entry3();
