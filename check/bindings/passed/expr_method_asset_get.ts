...
export class Expr_method_asset_get {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_method_asset_get.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_method_asset_get = new Expr_method_asset_get();
