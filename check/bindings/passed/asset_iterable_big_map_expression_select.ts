...
export class Asset_iterable_big_map_expression_select {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_iterable_big_map_expression_select.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_iterable_big_map_expression_select = new Asset_iterable_big_map_expression_select();
