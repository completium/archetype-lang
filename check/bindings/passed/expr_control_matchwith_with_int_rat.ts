...
export class Expr_control_matchwith_with_int_rat {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_control_matchwith_with_int_rat.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_control_matchwith_with_int_rat = new Expr_control_matchwith_with_int_rat();
