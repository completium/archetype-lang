...
export class Unused_variable_opt {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/unused_variable_opt.arl", {}, params)).address;
        this.address = address;
    }
...
export const unused_variable_opt = new Unused_variable_opt();
