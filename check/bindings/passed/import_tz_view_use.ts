...
export class Import_tz_view_use {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/import_tz_view_use.arl", {}, params)).address;
        this.address = address;
    }
...
export const import_tz_view_use = new Import_tz_view_use();
