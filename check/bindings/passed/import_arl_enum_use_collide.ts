...
export class Import_arl_enum_use_collide {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/import_arl_enum_use_collide.arl", {}, params)).address;
        this.address = address;
    }
...
export const import_arl_enum_use_collide = new Import_arl_enum_use_collide();
