...
export const o_asset_container_mich_type: att.MichelineType = att.pair_annot_to_mich_type("map", att.prim_annot_to_mich_type("nat", []), att.prim_annot_to_mich_type("string", []), []);
...
export class Test_asset_select_agg_1 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_select_agg_1.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_select_agg_1 = new Test_asset_select_agg_1();
