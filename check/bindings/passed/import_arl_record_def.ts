...
export class Import_arl_record_def {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/import_arl_record_def.arl", {}, params)).address;
        this.address = address;
    }
    errors = {};
}
export const import_arl_record_def = new Import_arl_record_def();
