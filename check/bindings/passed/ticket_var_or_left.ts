...
export class Ticket_var_or_left {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_var_or_left.arl", {}, params)).address;
        this.address = address;
    }
...
export const ticket_var_or_left = new Ticket_var_or_left();
