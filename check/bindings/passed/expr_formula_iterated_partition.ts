...
export class Expr_formula_iterated_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_formula_iterated_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_formula_iterated_partition = new Expr_formula_iterated_partition();
