...
export class Col_iter_direct_storage {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/col_iter_direct_storage.arl", {}, params)).address;
        this.address = address;
    }
...
export const col_iter_direct_storage = new Col_iter_direct_storage();
