...
export class Multi_ident_match_option {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/multi_ident_match_option.arl", {}, params)).address;
        this.address = address;
    }
...
export const multi_ident_match_option = new Multi_ident_match_option();
