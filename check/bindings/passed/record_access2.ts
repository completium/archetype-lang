...
export class my_record implements att.ArchetypeType {
    constructor(public a: string, public b: att.Nat, public c: att.Bytes, public d: att.Int, public e: string, public f: my_record2, public g: att.Bytes, public h: att.Int) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
    ...
    static from_mich(input: att.Micheline): my_record {
        return new my_record(att.mich_to_string((input as att.Mpair).args[0]), att.Nat.from_mich((input as att.Mpair).args[1]), att.Bytes.from_mich((input as att.Mpair).args[2]), att.Int.from_mich((input as att.Mpair).args[3]), att.mich_to_string((input as att.Mpair).args[4]), my_record2.from_mich((input as att.Mpair).args[5]), att.Bytes.from_mich((input as att.Mpair).args[6]), att.Int.from_mich((input as att.Mpair).args[7]));
    }
}
