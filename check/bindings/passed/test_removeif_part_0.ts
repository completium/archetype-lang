...
export class Test_removeif_part_0 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_removeif_part_0.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_removeif_part_0 = new Test_removeif_part_0();
