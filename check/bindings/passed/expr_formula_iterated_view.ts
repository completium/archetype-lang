...
export class Expr_formula_iterated_view {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_formula_iterated_view.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_formula_iterated_view = new Expr_formula_iterated_view();
