...
export class Expr_formula_cmp_eq_option {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_formula_cmp_eq_option.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_formula_cmp_eq_option = new Expr_formula_cmp_eq_option();
