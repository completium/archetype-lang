...
export class View_simple_caller {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/view_simple_caller.arl", {}, params)).address;
        this.address = address;
    }
...
export const view_simple_caller = new View_simple_caller();
