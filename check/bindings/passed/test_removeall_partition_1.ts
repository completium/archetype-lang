...
export class Test_removeall_partition_1 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_removeall_partition_1.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_removeall_partition_1 = new Test_removeall_partition_1();
