...
export class Select_with_extra_var {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/select_with_extra_var.arl", {}, params)).address;
        this.address = address;
    }
...
export const select_with_extra_var = new Select_with_extra_var();
