...
export class Expr_formula_asset_method_diff_view {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_formula_asset_method_diff_view.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_formula_asset_method_diff_view = new Expr_formula_asset_method_diff_view();
