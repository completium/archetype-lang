...
export class Custom_storage9 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/custom_storage9.arl", {}, params)).address;
        this.address = address;
    }
...
export const custom_storage9 = new Custom_storage9();
