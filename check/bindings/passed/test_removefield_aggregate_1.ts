...
export class Test_removefield_aggregate_1 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_removefield_aggregate_1.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_removefield_aggregate_1 = new Test_removefield_aggregate_1();
