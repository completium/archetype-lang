...
export class Custom_storage7 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/custom_storage7.arl", {}, params)).address;
        this.address = address;
    }
...
export const custom_storage7 = new Custom_storage7();
