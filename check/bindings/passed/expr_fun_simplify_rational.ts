...
export class Expr_fun_simplify_rational {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_fun_simplify_rational.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_fun_simplify_rational = new Expr_fun_simplify_rational();
