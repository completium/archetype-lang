...
export class Effect_instruction_put_in_asset {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_instruction_put_in_asset.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_instruction_put_in_asset = new Effect_instruction_put_in_asset();
