...
export class Match_detach_big_map {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/match_detach_big_map.arl", {}, params)).address;
        this.address = address;
    }
...
export const match_detach_big_map = new Match_detach_big_map();
