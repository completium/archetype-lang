...
export class Simple_asset_skip_empty_one_field {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/simple_asset_skip_empty_one_field.arl", {}, params)).address;
        this.address = address;
    }
...
export const simple_asset_skip_empty_one_field = new Simple_asset_skip_empty_one_field();
