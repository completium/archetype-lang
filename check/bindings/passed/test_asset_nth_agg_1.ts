...
export const o_asset_value_mich_type: att.MichelineType = att.prim_annot_to_mich_type("bool", []);
...
export const o_asset_container_mich_type: att.MichelineType = att.pair_annot_to_mich_type("map", att.prim_annot_to_mich_type("string", []), att.prim_annot_to_mich_type("bool", []), []);
...
export class Test_asset_nth_agg_1 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_nth_agg_1.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_nth_agg_1 = new Test_asset_nth_agg_1();
