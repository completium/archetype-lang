...
export class Effect_control_for_aggregate {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_control_for_aggregate.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_control_for_aggregate = new Effect_control_for_aggregate();
