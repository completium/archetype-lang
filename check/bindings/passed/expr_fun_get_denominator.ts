...
export class Expr_fun_get_denominator {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_fun_get_denominator.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_fun_get_denominator = new Expr_fun_get_denominator();
