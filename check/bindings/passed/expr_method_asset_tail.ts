...
export class Expr_method_asset_tail {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_method_asset_tail.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_method_asset_tail = new Expr_method_asset_tail();
