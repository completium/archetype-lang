...
export class Ticket_detach_option {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_detach_option.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_input(): Promise<att.Option<att.Ticket<string>>> {
        if (this.address != undefined) {
...
export const ticket_detach_option = new Ticket_detach_option();
