...
export class Rat_arith_minus {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/rat_arith_minus.arl", {}, params)).address;
        this.address = address;
    }
...
export const rat_arith_minus = new Rat_arith_minus();
