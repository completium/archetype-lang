...
export class Ticket_read_ticket_record {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_read_ticket_record.arl", {}, params)).address;
        this.address = address;
    }
...
export const ticket_read_ticket_record = new Ticket_read_ticket_record();
