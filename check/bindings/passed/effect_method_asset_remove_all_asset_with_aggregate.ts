...
export class my_asset_value implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.value.to_mich(), att.list_to_mich(this.p, x => {
                return x.to_mich();
            })]);
    }
...
export class Effect_method_asset_remove_all_asset_with_aggregate {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_remove_all_asset_with_aggregate.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_remove_all_asset_with_aggregate = new Effect_method_asset_remove_all_asset_with_aggregate();
