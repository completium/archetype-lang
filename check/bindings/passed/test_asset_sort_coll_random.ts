...
export class Test_asset_sort_coll_random {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_sort_coll_random.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_sort_coll_random = new Test_asset_sort_coll_random();
