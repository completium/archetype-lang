...
export class Asset_init_by_const_key {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_init_by_const_key.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_init_by_const_key = new Asset_init_by_const_key();
