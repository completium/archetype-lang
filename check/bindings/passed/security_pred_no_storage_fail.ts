...
export class Security_pred_no_storage_fail {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/security_pred_no_storage_fail.arl", {}, params)).address;
        this.address = address;
    }
...
export const security_pred_no_storage_fail = new Security_pred_no_storage_fail();
