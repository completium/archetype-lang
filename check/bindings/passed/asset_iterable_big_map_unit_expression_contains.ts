...
export class Asset_iterable_big_map_unit_expression_contains {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_iterable_big_map_unit_expression_contains.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_iterable_big_map_unit_expression_contains = new Asset_iterable_big_map_unit_expression_contains();
