...
export class Implicit_cast_to_view {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/implicit_cast_to_view.arl", {}, params)).address;
        this.address = address;
    }
...
export const implicit_cast_to_view = new Implicit_cast_to_view();
