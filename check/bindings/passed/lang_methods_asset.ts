...
export const asset_0_key_mich_type: att.MichelineType = att.prim_annot_to_mich_type("string", []);
...
export const asset_0_value_mich_type: att.MichelineType = att.prim_annot_to_mich_type("int", []);
...
export type asset_0_container = Array<[
    string,
    att.Int
]>;
...
export const asset_0_container_mich_type: att.MichelineType = att.pair_annot_to_mich_type("map", att.prim_annot_to_mich_type("string", []), att.prim_annot_to_mich_type("int", []), []);
...
export class Lang_methods_asset {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/lang_methods_asset.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_asset_0(): Promise<asset_0_container> {
        if (this.address != undefined) {
...
export const lang_methods_asset = new Lang_methods_asset();
