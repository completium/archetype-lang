...
export class Test_asset_view {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_view.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_view = new Test_asset_view();
