...
export class Import_arl_fun_instr_pure_use {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/import_arl_fun_instr_pure_use.arl", {}, params)).address;
        this.address = address;
    }
...
export const import_arl_fun_instr_pure_use = new Import_arl_fun_instr_pure_use();
