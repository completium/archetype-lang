...
export class Expr_fun_int_to_bytes {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_fun_int_to_bytes.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_fun_int_to_bytes = new Expr_fun_int_to_bytes();
