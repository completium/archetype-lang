...
export class Expr_control_matchwith_with_nat_int {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_control_matchwith_with_nat_int.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_control_matchwith_with_nat_int = new Expr_control_matchwith_with_nat_int();
