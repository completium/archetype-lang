...
export class Asset_not_found {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_not_found.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_not_found = new Asset_not_found();
