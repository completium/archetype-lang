...
export class Asset_iterable_big_map_multi_effect_remove {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_iterable_big_map_multi_effect_remove.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_iterable_big_map_multi_effect_remove = new Asset_iterable_big_map_multi_effect_remove();
