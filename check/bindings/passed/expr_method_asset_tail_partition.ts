...
export class Expr_method_asset_tail_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_method_asset_tail_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_method_asset_tail_partition = new Expr_method_asset_tail_partition();
