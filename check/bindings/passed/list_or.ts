...
export class List_or {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/list_or.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_l(): Promise<Array<att.Or<att.Nat, string>>> {
        if (this.address != undefined) {
...
export const list_or = new List_or();
