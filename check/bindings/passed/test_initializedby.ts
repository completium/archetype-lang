...
export class my_asset_value implements att.ArchetypeType {
    constructor(public v1: att.Int, public v2: att.Int) { }
    toString(): string {
...
export class Test_initializedby {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_initializedby.arl", {}, params)).address;
        this.address = address;
    }
    ...
    errors = {
        NOTHING: att.string_to_mich("\"nothing\"")
    };
}
export const test_initializedby = new Test_initializedby();
