...
export class Expr_record_update_asset_in_formula {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_record_update_asset_in_formula.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_record_update_asset_in_formula = new Expr_record_update_asset_in_formula();
