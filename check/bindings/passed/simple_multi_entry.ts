...
export class Simple_multi_entry {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/simple_multi_entry.arl", {}, params)).address;
        this.address = address;
    }
...
export const simple_multi_entry = new Simple_multi_entry();
