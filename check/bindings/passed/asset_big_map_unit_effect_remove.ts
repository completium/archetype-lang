...
export class Asset_big_map_unit_effect_remove {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_big_map_unit_effect_remove.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_big_map_unit_effect_remove = new Asset_big_map_unit_effect_remove();
