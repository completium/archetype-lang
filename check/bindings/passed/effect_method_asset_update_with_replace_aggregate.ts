...
export class Effect_method_asset_update_with_replace_aggregate {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_update_with_replace_aggregate.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_update_with_replace_aggregate = new Effect_method_asset_update_with_replace_aggregate();
