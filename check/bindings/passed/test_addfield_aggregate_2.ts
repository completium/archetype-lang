...
export class Test_addfield_aggregate_2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_addfield_aggregate_2.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_addfield_aggregate_2 = new Test_addfield_aggregate_2();
