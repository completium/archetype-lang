...
export class Import_arl_view_use_all {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/import_arl_view_use_all.arl", {}, params)).address;
        this.address = address;
    }
    ...
    errors = {
        VIEW_ERROR: att.string_to_mich("\"VIEW_ERROR\"")
    };
}
export const import_arl_view_use_all = new Import_arl_view_use_all();
