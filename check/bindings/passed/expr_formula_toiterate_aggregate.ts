...
export class Expr_formula_toiterate_aggregate {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_formula_toiterate_aggregate.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_formula_toiterate_aggregate = new Expr_formula_toiterate_aggregate();
