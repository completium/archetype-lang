...
export class Ticket_var_simple {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_var_simple.arl", {}, params)).address;
        this.address = address;
    }
...
export const ticket_var_simple = new Ticket_var_simple();
