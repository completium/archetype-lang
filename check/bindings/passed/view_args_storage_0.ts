...
export class View_args_storage_0 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/view_args_storage_0.arl", {}, params)).address;
        this.address = address;
    }
...
export const view_args_storage_0 = new View_args_storage_0();
