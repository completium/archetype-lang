...
export class Asset_big_map_unit_effect_removeall {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_big_map_unit_effect_removeall.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_big_map_unit_effect_removeall = new Asset_big_map_unit_effect_removeall();
