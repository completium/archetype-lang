...
export class Expr_method_asset_count {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_method_asset_count.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_method_asset_count = new Expr_method_asset_count();
