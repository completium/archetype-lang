...
export class Asset_big_map_unit_effect_add {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_big_map_unit_effect_add.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_big_map_unit_effect_add = new Asset_big_map_unit_effect_add();
