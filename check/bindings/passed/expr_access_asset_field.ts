...
export class Expr_access_asset_field {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_access_asset_field.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_access_asset_field = new Expr_access_asset_field();
