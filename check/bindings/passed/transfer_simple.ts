...
export class Transfer_simple {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/transfer_simple.arl", {}, params)).address;
        this.address = address;
    }
...
export const transfer_simple = new Transfer_simple();
