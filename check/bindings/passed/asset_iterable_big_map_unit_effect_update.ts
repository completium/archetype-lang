...
export class Asset_iterable_big_map_unit_effect_update {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_iterable_big_map_unit_effect_update.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_iterable_big_map_unit_effect_update = new Asset_iterable_big_map_unit_effect_update();
