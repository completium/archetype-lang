...
export class Custom_storage8 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/custom_storage8.arl", {}, params)).address;
        this.address = address;
    }
...
export const custom_storage8 = new Custom_storage8();
