...
export class Custom_storage3 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/custom_storage3.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_b(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich((((storage as att.Mpair).args[0] as att.Mpair).args[0] as att.Mpair).args[1]);
        }
        throw new Error("Contract not initialised");
    }
    async get_c(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich(((((storage as att.Mpair).args[0] as att.Mpair).args[1] as att.Mpair).args[0] as att.Mpair).args[0]);
        }
        throw new Error("Contract not initialised");
    }
    async get_d(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich(((((storage as att.Mpair).args[0] as att.Mpair).args[1] as att.Mpair).args[0] as att.Mpair).args[1]);
        }
        throw new Error("Contract not initialised");
    }
    async get_e(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich(((((storage as att.Mpair).args[0] as att.Mpair).args[1] as att.Mpair).args[1] as att.Mpair).args[0]);
        }
        throw new Error("Contract not initialised");
    }
    async get_f(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich(((((storage as att.Mpair).args[0] as att.Mpair).args[1] as att.Mpair).args[1] as att.Mpair).args[1]);
        }
        throw new Error("Contract not initialised");
    }
    async get_g(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich(((((storage as att.Mpair).args[0] as att.Mpair).args[1] as att.Mpair).args[1] as att.Mpair).args[2]);
        }
        throw new Error("Contract not initialised");
    }
    async get_h(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich(((((storage as att.Mpair).args[0] as att.Mpair).args[1] as att.Mpair).args[1] as att.Mpair).args[3]);
        }
        throw new Error("Contract not initialised");
    }
    async get_i(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich((((storage as att.Mpair).args[0] as att.Mpair).args[1] as att.Mpair).args[2]);
        }
        throw new Error("Contract not initialised");
    }
    async get_j(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich(((storage as att.Mpair).args[0] as att.Mpair).args[2]);
        }
        throw new Error("Contract not initialised");
    }
    async get_k(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich((((storage as att.Mpair).args[0] as att.Mpair).args[3] as att.Mpair).args[0]);
        }
        throw new Error("Contract not initialised");
    }
    async get_l(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich((((storage as att.Mpair).args[0] as att.Mpair).args[3] as att.Mpair).args[1]);
        }
        throw new Error("Contract not initialised");
    }
    async get_m(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich(((storage as att.Mpair).args[0] as att.Mpair).args[4]);
        }
        throw new Error("Contract not initialised");
    }
    errors = {};
}
export const custom_storage3 = new Custom_storage3();
