...
export class Import_arl_asset_def {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/import_arl_asset_def.arl", {}, params)).address;
        this.address = address;
    }
...
export const import_arl_asset_def = new Import_arl_asset_def();
