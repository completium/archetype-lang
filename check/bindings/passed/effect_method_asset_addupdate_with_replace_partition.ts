...
export class Effect_method_asset_add_update_with_replace_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_add_update_with_replace_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_add_update_with_replace_partition = new Effect_method_asset_add_update_with_replace_partition();
