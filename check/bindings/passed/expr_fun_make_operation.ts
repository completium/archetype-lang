...
export class Expr_fun_make_operation {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_fun_make_operation.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_fun_make_operation = new Expr_fun_make_operation();
