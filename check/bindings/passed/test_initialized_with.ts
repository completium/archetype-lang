...
export class Test_initialized_with {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_initialized_with.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_initialized_with = new Test_initialized_with();
