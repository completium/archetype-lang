...
export class Test_remove_asset_with_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_remove_asset_with_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_remove_asset_with_partition = new Test_remove_asset_with_partition();
