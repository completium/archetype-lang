...
export class Expr_method_asset_sort_aggregate {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_method_asset_sort_aggregate.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_method_asset_sort_aggregate = new Expr_method_asset_sort_aggregate();
