...
export class Test_asset_select_coll_0 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_select_coll_0.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_select_coll_0 = new Test_asset_select_coll_0();
