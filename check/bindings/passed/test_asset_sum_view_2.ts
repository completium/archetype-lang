...
export class my_asset_value implements att.ArchetypeType {
    constructor(public value: att.Int, public b: boolean) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.value.to_mich(), att.bool_to_mich(this.b)]);
    }
...
export class Test_asset_sum_view_2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_sum_view_2.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_sum_view_2 = new Test_asset_sum_view_2();
