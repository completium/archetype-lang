...
export class Effect_method_asset_remove_all_asset_with_partition {
...
export const effect_method_asset_remove_all_asset_with_partition = new Effect_method_asset_remove_all_asset_with_partition();
