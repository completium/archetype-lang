...
export class With_metadata_json {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/with_metadata_json.arl", {}, params)).address;
        this.address = address;
    }
...
export const with_metadata_json = new With_metadata_json();
