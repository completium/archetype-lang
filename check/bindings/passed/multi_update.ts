...
export class my_asset_value implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.v1.to_mich(), this.v2.to_mich(), this.v3.to_mich()]);
    }
...
export class Multi_update {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/multi_update.arl", {}, params)).address;
        this.address = address;
    }
...
export const multi_update = new Multi_update();
