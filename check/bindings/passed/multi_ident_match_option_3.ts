...
export class Multi_ident_match_option_3 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/multi_ident_match_option_3.arl", {}, params)).address;
        this.address = address;
    }
...
export const multi_ident_match_option_3 = new Multi_ident_match_option_3();
