...
export class Init_asset_with_const {
    ...
    async deploy(init_value: Array<[
        string,
        att.Nat
    ]>, params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/init_asset_with_const.arl", {
            init_value: att.list_to_mich(init_value, x => {
                const x_key = x[0];
                const x_value = x[1];
...
export const init_asset_with_const = new Init_asset_with_const();
