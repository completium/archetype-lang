...
export class Test_asset_select_view_2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_asset_select_view_2.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_asset_select_view_2 = new Test_asset_select_view_2();
