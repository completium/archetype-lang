...
export class Security_pred_not_by_role {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/security_pred_not_by_role.arl", {}, params)).address;
        this.address = address;
    }
...
export const security_pred_not_by_role = new Security_pred_not_by_role();
