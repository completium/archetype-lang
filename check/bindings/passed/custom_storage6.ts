...
export class my_record implements att.ArchetypeType {
    ...
    static from_mich(input: att.Micheline): my_record {
        return new my_record(att.Int.from_mich(input), att.Nat.from_mich(input), att.Address.from_mich(input));
    }
}
...
export class Custom_storage6 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/custom_storage6.arl", {}, params)).address;
        this.address = address;
    }
...
export const custom_storage6 = new Custom_storage6();
