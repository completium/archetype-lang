...
const e2_arg_to_mich = (r: my_record, c: att.Entrypoint): att.Micheline => {
...
export class Import_arl_all_def {
    ...
    async e2(r: my_record, c: att.Entrypoint, params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "e2", e2_arg_to_mich(r, c), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_e2_param(r: my_record, c: att.Entrypoint, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "e2", e2_arg_to_mich(r, c), params);
        }
        throw new Error("Contract not initialised");
    }
