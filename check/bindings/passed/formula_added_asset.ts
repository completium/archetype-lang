...
export class Formula_added_asset {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/formula_added_asset.arl", {}, params)).address;
        this.address = address;
    }
...
export const formula_added_asset = new Formula_added_asset();
