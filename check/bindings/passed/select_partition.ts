...
export class Select_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/select_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const select_partition = new Select_partition();
