...
export class Transfer_simple_with_entrypoint {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/transfer_simple_with_entrypoint.arl", {}, params)).address;
        this.address = address;
    }
...
export const transfer_simple_with_entrypoint = new Transfer_simple_with_entrypoint();
