...
export class Sample_sandbox_exec {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/sample_sandbox_exec.arl", {}, params)).address;
        this.address = address;
    }
...
export const sample_sandbox_exec = new Sample_sandbox_exec();
