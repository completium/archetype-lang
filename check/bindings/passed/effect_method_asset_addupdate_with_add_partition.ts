...
export const my_asset_simple_key_mich_type: att.MichelineType = att.prim_annot_to_mich_type("int", []);
export const my_asset_key_mich_type: att.MichelineType = att.prim_annot_to_mich_type("string", []);
export class my_asset_value implements att.ArchetypeType {
    constructor(public value: att.Int, public mypartition: Array<att.Int>) { }
    toString(): string {
...
export const my_asset_value_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    ...
    att.set_annot_to_mich_type(att.prim_annot_to_mich_type("int", []), ["%mypartition"])
], []);
export type my_asset_simple_container = Array<att.Int>;
export type my_asset_container = Array<[
    string,
    my_asset_value
]>;
export const my_asset_simple_container_mich_type: att.MichelineType = att.set_annot_to_mich_type(att.prim_annot_to_mich_type("int", []), []);
...
export class Effect_method_asset_add_update_with_add_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_add_update_with_add_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_add_update_with_add_partition = new Effect_method_asset_add_update_with_add_partition();
