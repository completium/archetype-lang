...
export class Expr_formula_asset_method_empty {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_formula_asset_method_empty.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_formula_asset_method_empty = new Expr_formula_asset_method_empty();
