...
export class Expr_record_update_record_in_exec {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_record_update_record_in_exec.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_record_update_record_in_exec = new Expr_record_update_record_in_exec();
