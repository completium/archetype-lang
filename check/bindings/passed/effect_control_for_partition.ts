...
export class Effect_control_for_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_control_for_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_control_for_partition = new Effect_control_for_partition();
