...
export class Transfer_entrypoint {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/transfer_entrypoint.arl", {}, params)).address;
        this.address = address;
    }
...
export const transfer_entrypoint = new Transfer_entrypoint();
