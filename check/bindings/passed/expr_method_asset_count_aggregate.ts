...
export class Expr_method_asset_count_aggregate {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_method_asset_count_aggregate.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_method_asset_count_aggregate = new Expr_method_asset_count_aggregate();
