...
export class Effect_method_asset_add_asset_with_partition_2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_add_asset_with_partition_2.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_o_asset2(): Promise<o_asset2_container> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
...
export const effect_method_asset_add_asset_with_partition_2 = new Effect_method_asset_add_asset_with_partition_2();
