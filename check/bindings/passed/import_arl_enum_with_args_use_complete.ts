...
export class Import_arl_enum_with_args_use_complete {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/import_arl_enum_with_args_use_complete.arl", {}, params)).address;
        this.address = address;
    }
...
export const import_arl_enum_with_args_use_complete = new Import_arl_enum_with_args_use_complete();
