...
export class Expr_method_asset_head_view {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_method_asset_head_view.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_method_asset_head_view = new Expr_method_asset_head_view();
