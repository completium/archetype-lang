...
export class Asset_initializedby_aggregate_filled {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_initializedby_aggregate_filled.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_initializedby_aggregate_filled = new Asset_initializedby_aggregate_filled();
