...
export class Effect_method_asset_remove_all_collection {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_remove_all_collection.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_remove_all_collection = new Effect_method_asset_remove_all_collection();
