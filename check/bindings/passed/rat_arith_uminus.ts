...
export class Rat_arith_uminus {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/rat_arith_uminus.arl", {}, params)).address;
        this.address = address;
    }
...
export const rat_arith_uminus = new Rat_arith_uminus();
