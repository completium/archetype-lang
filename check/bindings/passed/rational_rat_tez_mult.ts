...
export class Rational_rat_tez_mult {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/rational_rat_tez_mult.arl", {}, params)).address;
        this.address = address;
    }
...
export const rational_rat_tez_mult = new Rational_rat_tez_mult();
