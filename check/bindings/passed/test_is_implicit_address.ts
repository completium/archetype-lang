...
export class Test_is_implicit_address {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/test_is_implicit_address.arl", {}, params)).address;
        this.address = address;
    }
...
export const test_is_implicit_address = new Test_is_implicit_address();
