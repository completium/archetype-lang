...
export class Asset_initializedby_aggregate_empty {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_initializedby_aggregate_empty.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_initializedby_aggregate_empty = new Asset_initializedby_aggregate_empty();
