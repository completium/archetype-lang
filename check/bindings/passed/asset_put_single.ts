...
export class Asset_put_single {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/asset_put_single.arl", {}, params)).address;
        this.address = address;
    }
...
export const asset_put_single = new Asset_put_single();
