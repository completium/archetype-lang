...
export class Expr_instr_rec_4_0 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_instr_rec_4_0.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_instr_rec_4_0 = new Expr_instr_rec_4_0();
