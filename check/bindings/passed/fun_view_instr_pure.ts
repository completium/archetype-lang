...
export class Fun_view_instr_pure {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/fun_view_instr_pure.arl", {}, params)).address;
        this.address = address;
    }
...
export const fun_view_instr_pure = new Fun_view_instr_pure();
