...
export class Expr_fun_bytes_to_nat {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_fun_bytes_to_nat.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_fun_bytes_to_nat = new Expr_fun_bytes_to_nat();
