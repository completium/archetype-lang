...
export class Ticket_read_ticket_arg_record_list {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_read_ticket_arg_record_list.arl", {}, params)).address;
        this.address = address;
    }
...
export const ticket_read_ticket_arg_record_list = new Ticket_read_ticket_arg_record_list();
