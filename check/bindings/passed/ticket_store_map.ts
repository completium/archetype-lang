...
export class Ticket_store_map {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_store_map.arl", {}, params)).address;
        this.address = address;
    }
...
export const ticket_store_map = new Ticket_store_map();
