...
export class Effect_method_asset_update_with_map {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_update_with_map.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_update_with_map = new Effect_method_asset_update_with_map();
