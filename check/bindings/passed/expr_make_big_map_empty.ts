...
export class Expr_make_big_map_empty {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_make_big_map_empty.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_make_big_map_empty = new Expr_make_big_map_empty();
