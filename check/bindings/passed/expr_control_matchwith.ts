...
export class Expr_control_matchwith {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_control_matchwith.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_control_matchwith = new Expr_control_matchwith();
