...
export class Expr_formula_asset_method_isempty {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/expr_formula_asset_method_isempty.arl", {}, params)).address;
        this.address = address;
    }
...
export const expr_formula_asset_method_isempty = new Expr_formula_asset_method_isempty();
