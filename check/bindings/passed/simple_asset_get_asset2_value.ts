...
export class Simple_asset_get_asset2_value {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/simple_asset_get_asset2_value.arl", {}, params)).address;
        this.address = address;
    }
...
export const simple_asset_get_asset2_value = new Simple_asset_get_asset2_value();
