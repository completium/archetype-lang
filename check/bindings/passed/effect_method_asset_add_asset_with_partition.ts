...
export class Effect_method_asset_add_asset_with_partition {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_add_asset_with_partition.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_add_asset_with_partition = new Effect_method_asset_add_asset_with_partition();
