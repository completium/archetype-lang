...
export class Ticket_var_option {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/ticket_var_option.arl", {}, params)).address;
        this.address = address;
    }
...
export const ticket_var_option = new Ticket_var_option();
