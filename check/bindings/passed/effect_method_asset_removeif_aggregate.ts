...
export class Effect_method_asset_remove_if_aggregate {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("../tests/passed/effect_method_asset_remove_if_aggregate.arl", {}, params)).address;
        this.address = address;
    }
...
export const effect_method_asset_remove_if_aggregate = new Effect_method_asset_remove_if_aggregate();
