...
(defconst cml-font-lock-keywords-1
  (list
   ...
   `(,(cml-regexp-opt '("identified" "sorted" "by" "as" "from" "to" "with" "ref" "fun" "=>" "collection" "queue" "stack" "set" "subset" "partition" "asset" "assert" "object" "initial" "ensure" "args" "called" "condition" "transferred" "action" "let" "if" "then" "else" "for" "in" "of" "transfer" "back" "and" "or" "not" "forall" "exists" "break")) . font-lock-keyword-face))
