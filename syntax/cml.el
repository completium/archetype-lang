...
(defconst cml-font-lock-keywords-1
  (list
   ...
   `(,(cml-regexp-opt '("use" "model" "extension" "constant" "value" "role" "asset" "value" "states" "enum" "transition" "transaction" "function" "object" "key" "namespace" "contract")) . font-lock-type-face)
