...
let string_of_symbol = function
  ...
  | X (N N_verif_items) -> "a list of verification item"
  ...
  | X (N N_type_r) -> "a type"
  | X (N N_list_loc_verif_variable__) -> "a list of verification variable item"
  | X (N N_list_loc_verif_theorem__) -> "a list of verification theorem item"
  | X (N N_list_loc_verif_specification__) -> "a list of verification specification item"
  | X (N N_list_loc_verif_predicate__ ) -> "a list of verification predicate item"
  | X (N N_list_loc_verif_effect__) -> "a list of verification effect item"
  | X (N N_list_loc_verif_definition__) -> "a list of verification definition item"
  | X (N N_list_loc_verif_axiom__) -> "a list of verification axiom item"
  | X (N N_list_loc_verif_assert__) -> "a list of verification assert item"
