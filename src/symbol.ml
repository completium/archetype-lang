...
let string_of_symbol = function
  ...
  | X (T T_SEMI_COLON) -> ";"
  | X (T T_SELF) -> "self"
  | X (T T_SELF_CONTRACT) -> "self_contract"
  ...
  | X (T T_MATCH) -> "match"
  | X (T T_MATCH_DETACH) -> "match_detach"
  | X (T T_MAP) -> "map"
  ...
  | X (N N_rf_unloc_WITH_) -> "rf_unloc_WITH"
  | X (N N_rf_unloc_OTHERWISE_) -> "cf_unloc_OTHERWISE"
  ...
  | X (N N_getter) -> "a getter"
  | X (N N_getter_simple) -> "a getter simple"
