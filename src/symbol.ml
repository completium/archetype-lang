...
let string_of_symbol = function
  ...
  | X (T T_MINUS) -> "-"
  | X (T T_MATCH) -> "match"
  | X (T T_MATCH_OR)-> "match_or"
  | X (T T_MATCH_OPTION) -> "match_option"
  | X (T T_MATCH_LIST) -> "match_list"
  | X (T T_MAP) -> "map"
  | X (T T_LPAREN) -> "("
  | X (T T_LOOP_LEFT) -> "loop_left"
  | X (T T_LIST) -> "list"
  | X (T T_LET) -> "let"
  | X (T T_LESSEQUAL) -> "<="
  | X (T T_LESS) -> "<"
  ...
  | X (N N_vc_decl_PARAMETER_) -> "a parameter declaration"
