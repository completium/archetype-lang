...
let string_of_symbol = function
  ...
  | X (N N_snl_SEMI_COLON_efield_) -> "a non empty list of event field"
  ...
  | X (N N_sl_SEMI_COLON_efield_) -> "a list of event field"
  ...
  | X (N N_option_event_fields_) -> "an option event fields"
