...
type ('id, 'term) mterm_node  =
  ...
  | Mappexternal of ('id * 'id * 'term * ('term) list)
  | Mappget      of ('term * 'term)
  | Mappadd      of ('term * 'term)
  | Mappremove   of ('term * 'term)
  | Mappclear    of ('term)
  | Mappupdate
  | Mappreverse  of ('term)
  | Mappsort
  | Mappcontains of ('term * 'term)
  | Mappnth      of ('term * 'term)
  | Mappselect
  | Mappcount    of ('term)
  | Mappsum      of ('id * 'term)
  | Mappmin      of ('id * 'term)
